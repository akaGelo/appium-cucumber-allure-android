...
public class Wrapper extends Assert {
    ...
    public Wrapper(AndroidDriver<AndroidElement> driver) {
        this.driver = driver;
    }
    ...
    public static void scrollToText(String text) {
        driver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector()).setSwipeDeadZonePercentage(0.3).scrollIntoView(text(\"" + text + "\"));");
    }
